...
var demoProjectName = "VertiqTodoSample.Server";
var demoProjectDir = $"src/{demoProjectName}/";
var demoCSprojPath = Path.Combine(demoProjectDir, $"{demoProjectName}.csproj");

var iisPackageName = Environment.GetEnvironmentVariable("WEBDEPLOY_SITENAME") ?? "todo.vertiq.io";
